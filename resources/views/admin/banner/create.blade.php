...
@section('title', 'Create new a Banner')
@section('main')
    ...
    <form action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-7">
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control description" placeholder="Banner content">{{old('description')}}</textarea>
                @error('description')
                <small>{{$message}}</small>
                @enderror
            </div>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="prioty" class="form-control" id="" placeholder="Input field" value="{{old('prioty')}}">
                @error('prioty')
                <small>{{$message}}</small>
                @enderror
            </div>
